...
public class SceneController {
        ...
        public enum Scenes {
            MENU(new FXMLLoader(SceneController.class.getResource("Menu.fxml"))),
            LOADING(new FXMLLoader(SceneController.class.getResource("LoadingScene.fxml"))),
            TRADER(new FXMLLoader(SceneController.class.getResource("Trader.fxml")));
